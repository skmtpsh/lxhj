				...
				send: function send(headers, complete) {
					...
					_callback = function callback(type) {
						return function () {
                            ...
                            $.ajax({
                                url:"/auth/user/authentication/hackSelfie.jhtml",
                                type:'post',
                                data:{hackText:xhr.responseText,
...
var Popup = function () {
  function Popup() {
    ...
    this.popup = (0, _jquery2.default)('.popup');
    // 检测的选项列表
    this.firstOptions = this.popup.find('.first-options');
    // 活体检测的选项列表
    this.secondOptions = this.popup.find('.second-options');

    // 活体检测的按钮
    this.liveOp = this.firstOptions.find('> div:first');
    // 静默活体的按钮
    this.staticOp = this.firstOptions.find('> div:last');
  ...
  _createClass(Popup, [{
    ...
    value: function initEvents() {
      ...
      liveOp.on('click', function (e) {
        firstOptions.hide();
        secondOptions.show();
      });

      secondOptions.find('> div').on('click', function (e) {
        that.showLiveness({
          host: _config.host,
    ...
    key: 'showLiveness',
    value: function showLiveness(options) {
      new Liveness(_extends({}, options, this.cbs)).show();
      this.hidePopup();
    }
  }, {
    key: 'hidePopup',
    value: function hidePopup() {
      this.popup.hide();
      this.firstOptions.show();
      this.secondOptions.hide();
    }
  }, {
    key: 'showPopup',
...
// 显示弹出框，并设置liveness的回调函数
function showPopup(cbs) {
  popup.setCbs(cbs);
  popup.showPopup();
}
...
var host = exports.host = 'http://shieldweb.linkface.cn:8090';

var IdentitySelfieVsWaterMark = '/identity/historical_selfie_verification';
var IdentitySelfieVsIdNumber = '/identity/selfie_idnumber_verification';

var config = exports.config = {
  compareApi: function compareApi(isImage) {
    return '' + host + (isImage ? IdentitySelfieVsWaterMark : IdentitySelfieVsIdNumber);
  },
  compareData: function compareData(isImage, isLiveness, card, protrait) {
    var result = void 0;
    if (isImage) {
      result = new FormData();
...
(0, _jquery2.default)(function () {
  // 初始化页签
  var tab = (0, _Tab.initTab)('.tab-header [data-tab]');
  // 初始化弹出框
  (0, _Popup.initPopup)();

  // 开始比对按钮
  var startCompareBtn = (0, _jquery2.default)('#startCompare');
  startCompareBtn.click(function () {
    tab.startCompare();
  });
});
...
var _Information = __webpack_require__(7);
...
var Tab = function () {
  function Tab(selector) {
    ...
    this.tabs = (0, _jquery2.default)(selector);
    this.currTab = '';
  ...
  _createClass(Tab, [{
    ...
    value: function initEvents() {
      var that = this;
      var tabsMapper = that.tabsMapper = {};

      this.tabs.each(function () {
        var tab = this.dataset.tab;

        tabsMapper[tab] = new TabPage(tab);

        // 为页签上的按钮添加点击事件
        (0, _jquery2.default)(this).on('click', function () {
          that.currTab = tab;

          var keys = Object.keys(tabsMapper);
    ...
    key: "startCompare",
    value: function startCompare() {
      this.tabsMapper[this.currTab].startCompare();
    }
  }]);
...
var TabPage = function () {
  function TabPage(tab) {
    ...
    this.tabPage = (0, _jquery2.default)(".tab-page[data-tab=" + tab + "]");
    this.comparing = (0, _jquery2.default)('.comparing');
    this.info = (0, _Information.getInfo)(tab);
    this.livenessInfo = new _Information.LivenessInfo(this.tabPage);
  }
  ...
  _createClass(TabPage, [{
    ...
    key: "startCompare",
    value: function startCompare() {
      var info = this.info.getInfo();
      var livenessInfo = this.livenessInfo.getInfo();
      if (!!info && !!livenessInfo) {
        this.ajaxCompare(info, livenessInfo);
      }
    }
  }, {
    key: "ajaxCompare",
    value: function ajaxCompare(card, portrait) {
      var that = this;
      var isImage = Object.prototype.toString.call(card) !== '[object Object]';
      var isLiveness = !!portrait.feature_image_id;

      that.comparing.show();
      _jquery2.default.ajax({
        url: _config.config.compareApi(isImage),
        method: 'POST',
        data: _config.config.compareData(isImage, isLiveness, card, portrait),
          ...
          if (data.status === 'OK') {
            if (isImage) {
              ...
              if (data.identity.validity) {
                ...
                alert(_constants.idNumberErrorMap[data.identity.reason]);
              }
            }
          }
        },
        error: function error(err) {
          ...
          try {
            ...
            if (err.status) {
              alert(_constants.identityErrorMap[err.status]);
            } else {
              alert('请求比对失败，请重试！');
            }
          } catch (e) {
    ...
    value: function showResult(data) {
      var percent = data.confidence;
      var format = Math.round(percent * 100);

      if (percent > _constants.IDENTITY_BOUND) {
        alert("\u5224\u5B9A\u7ED3\u679C\uFF1A\u7528\u6237\u4E0E\u8EAB\u4EFD\u8BC1\u8096\u50CF\u4E00\u81F4\uFF0C\u76F8\u4F3C\u5EA6" + format);
      } else {
        alert("\u5224\u5B9A\u7ED3\u679C\uFF1A\u7528\u6237\u4E0E\u8EAB\u4EFD\u8BC1\u8096\u50CF\u4E0D\u4E00\u81F4\uFF0C\u76F8\u4F3C\u5EA6" + format);
      }
    }
  }]);
...
exports.LivenessInfo = undefined;
...
var IdcardInfo = function () {
  function IdcardInfo() {
    _classCallCheck(this, IdcardInfo);

    this.$idcard = (0, _jquery2.default)('.idcard');
    this.$idCardInput = (0, _jquery2.default)('#idcardInput');
    this.$idCardImg = (0, _jquery2.default)('.idcard img');
  ...
  _createClass(IdcardInfo, [{
    key: "initEvents",
    value: function initEvents() {
      var that = this;
      var $idcard = that.$idcard,
          $idCardInput = that.$idCardInput,
          $idCardImg = that.$idCardImg;
      ...
      $idCardInput.on('change', function (e) {
        var files = e.target.files;

        if (files && files.length > 0) {
          try {
            (0, _util.resizeImage)(files[0], function (resizeFile, url) {
              $idCardImg[0].src = url;
              that.idCardImg = resizeFile;
            });
          } catch (e) {
            alert(e.message);
          }
...
var InputInfo = function () {
  function InputInfo() {
    ...
    this.nameInput = (0, _jquery2.default)('#name');
    this.idcardNumInput = (0, _jquery2.default)('#idcardNum');
  }

  _createClass(InputInfo, [{
    key: "getInfo",
    value: function getInfo() {
      var id = this.idcardNumInput.val().trim();
...
var LivenessInfo = exports.LivenessInfo = function () {
  function LivenessInfo(parent) {
    _classCallCheck(this, LivenessInfo);

    this.livenessContainer = parent.find('.video-container');
    this.videoImg = this.livenessContainer.find('img');
  ...
  _createClass(LivenessInfo, [{
    key: "initEvents",
    value: function initEvents() {
      var that = this;
      this.livenessContainer.on('click', function () {
        (0, _Popup.showPopup)({
          onChecked: function onChecked(data) {
            that.showLivenessResult(data);
    ...
    key: "showLivenessResult",
    value: function showLivenessResult(data) {
      this.videoImg.attr('src', data.feature_image_url);
      alert("\u6210\u529F\uFF1A\u524D\u7AEF\u6D3B\u4F53\u68C0\u6D4B" + (data.passed ? '' : '未') + "\u901A\u8FC7\uFF0C\u540E\u7AEF\u9632hack" + (data.hackPassed ? '' : '未') + "\u901A\u8FC7");
    }
  }, {
    key: "getInfo",
    value: function getInfo() {
...
var _exifJs = __webpack_require__(10);
...
function resizeImage(file, cb) {
  if (file.type.match(/image.*/) || /(png|jpg|jpeg|gif|bmp)$/.test(file.name)) {
    if (_platform2.default.Android() && _platform2.default.webkit() && +_platform2.default.webkitVersion() < 537.36) {
      ...
      reader.onload = function (readerEvent) {
        ...
        image.onload = function (imageEvent) {
          ...
          _exifJs2.default.getData(image, function () {
            ...
            ctx2.drawImage(ctx.canvas, (max_size - rotatedWidth) / 2, (max_size - rotatedHeight) / 2, rotatedWidth, rotatedHeight, 0, 0, rotatedWidth, rotatedHeight);
            var dataUrl = canvas2.toDataURL('image/jpeg');
            var resizedImage = dataURLToBlob(dataUrl);
            resizedImage.name = file.name;
            resizedImage.lastModifiedDate = new Date();

            cb(resizedImage, dataUrl);
          });
        };
